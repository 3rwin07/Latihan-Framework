								...
								<div class="container-fluid">
									...
									<div class="collapse navbar-collapse navbar-ex1-collapse">
										<ul class="nav navbar-nav">
											...
											<li class="active"><a href="<?php echo site_url();?>/about"><span class="glyphicon glyphicon-user" aria-hidden="true"> About</a></li>
											<li><a href="<?php echo site_url();?>/contact"><span class="glyphicon glyphicon-phone-alt" aria-hidden="true"> Contact</a></li>
										</ul>
